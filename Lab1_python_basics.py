...
random_numbers = [randint(1, 100) for _ in range(10)]  # Генерируем 10 случайных чисел от 1 до 100

# 2. Создаем цикл, который проходит все элементы списка и суммирует только четные значения
sum_even = 0  # Переменная для хранения суммы четных чисел
for number in random_numbers:
    if number % 2 == 0:  # Проверяем, является ли число четным
        sum_even += number  # Если число четное, добавляем его к сумме

# 3. Выводим полученную сумму на экран в консоли
print("Выполнение задания 1.\n Список случайных чисел:", random_numbers)
